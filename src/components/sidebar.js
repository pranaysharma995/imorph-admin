    ...
    return (
        <div className="container sidebar" >
                ...
                <div className={/^\/dashboard\/users$/.test(window.location.pathname) || /^\/dashboard\/users\/edit$/.test(window.location.pathname) ? " row mb-4 sildeBar__active" : "row  mb-4 sildeBar__inactive"} >
                    {/^\/dashboard\/users$/.test(window.location.pathname)  ? <img width="20rem" height="20rem" className="mr-3 " style={{background :"transparent"}} src={userColor} alt="enquaries"/> : <img width="20rem" height="20rem" className="mr-3 " style={{background :"transparent"}} src={user} alt="enquaries"/>}
                ...
                <div className={/^\/dashboard\/inquiries$/.test(window.location.pathname) || /^\/dashboard\/inquiries\/view$/.test(window.location.pathname) ? " row mb-4 sildeBar__active" : "row  mb-4 sildeBar__inactive"}>
                ...
                <div className={/^\/dashboard\/subscription$/.test(window.location.pathname) || /^\/dashboard\/subscription\/create$/.test(window.location.pathname) || /^\/dashboard\/subscription\/edit$/.test(window.location.pathname) ? " row mb-4 mt-2 sildeBar__active" : "row mb-4 mt-4 sildeBar__inactive"} >
