...
const EditSubscription = ({plan}) => {
    ...
    useEffect(()=> {
        ...
        //     }
        //     fileReader.readAsDataURL(plan.image);
    ...
    const submit = ()=> {
        ...
        axiosInstance.post("/admin/subscription/update",data).then(() => (
            setBtnLoading(false),
    ...
    return (
        <div className="createSubscription">
             ...
             <h3 style={{color : "#707070"}}>Edit Subscription Plan</h3>
          ...
          <div className="d-flex justify-content-center">
                 {btnLoading ? (<div  className="spinner-border text-primary"></div>) : (<> <CustomButton customButton__class="btn profile__footerBtn" text="Save" type="submit" handleClick={handleValidation} />
                         <CustomButton customButton__class="btn profile__backbtn"  text="Cancel" onClick={oncancel}/></>)}
                    </div>
